...
type Config struct {
	...
	LoginURL       string `envconfig:"CSGHUB_PORTAL_LOGIN_URL" default:"http://home.sxcfx.cn:8000/login/oauth/authorize?client_id=7a97bc5168cb75ffc514&response_type=code&redirect_uri=http://localhost:8089/api/v1/callback/casdoor&scope=read&state=casdoor"`

	StarhubServer struct {
		BaseURL string `envconfig:"CSGHUB_PORTAL_STARHUB_BASE_URL" default:"http://home.sxcfx.cn:18120"`
	...
	Database struct {
		...
		DSN     string          `envconfig:"CSGHUB_PORTAL_DATABASE_DSN" default:"postgresql://admin:admin123456@home.sxcfx.cn:18119/csghub_development?sslmode=disable"`
