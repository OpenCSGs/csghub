Rails.application.routes.draw do
  ...
  namespace :internal_api do
    ...
    get '/users/likes/models', to: 'users#likes_models'
    get '/users/likes/datasets', to: 'users#likes_datasets'
    get '/users/likes/codes', to: 'users#likes_codes'
    get '/users/likes/spaces', to: 'users#likes_spaces'
