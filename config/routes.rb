Rails.application.routes.draw do
  ...
  scope "(:locale)", :locale => /en|zh/ do
    ...
    get '/finetune/:namespace/(*finetune_name)/:finetune_id/logs', to: 'finetune#logs', namespace: /[^\/]+/
    get '/finetune/:namespace/(*finetune_name)/:finetune_id/settings', to: 'finetune#settings', namespace: /[^\/]+/
    get '/finetune/:namespace/(*finetune_name)/:finetune_id', to: 'finetune#show', namespace: /[^\/]+/
