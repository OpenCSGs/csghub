export default {
  ...
  "product": {
    ...
    "starCloud": {
      ...
      "desc": "一站式大模型开发及服务运行平台，包括算力资源调度及算法训练推理服务",
      "demoVideo": "演示视频",
      "demo": "Demo体验",
    ...
    "starShip": {
      ...
      "desc": "为大模型应用开发团队提供一套完整的模型/数据管理及应用搭建平台",
      "demo": "产品演示"
    },
  },
  "solution": {
    ...
    "AIImg": {
      ...
      "desc": "为创作者提供更好用的工具，实现创意和生产力的指数级放大",
      "part1": "文生图绘图模式",
  ...
  "navbar": {
    ...
    "starCloudText": "将文档结构化并转换为数字资产，实现信息数字化存储和管理。",
    ...
    "solution": "方案",
    "EKB": "EKB AI 智能企业知识库",
    "EKBText": "将文档结构化并转换为数字资产，实现信息数字化存储和管理。",
    "starAIO": "StarAIO 大模型一体机",
    "starAIOText": "为开发者们提供了优秀的开源工具和平台，助力企业定制私有化大模型。",
    "imagen": "Imagen AI 智能图像助手",
    "imagenText": "Imagen AI 智能图像助手适应专业设计工作流程，提供多种功能。",
    "starCode": "StarCode AI 智能编程助手",
    "starCodeText": "通过基于大模型技术的创新功能，帮助开发者提高工作效率。",
    "developer": "开发者",
    "open": "开源CSGHub",
    "openText": "开源、可信的大模型资产管理平台",
    "llm_inference_open": "开源Inference",
    "llm_inference_open_text": "高效部署大语言模型（LLM）服务的引擎",
    "space": "应用空间",
    "spaceText": "大模型应用体验平台",
    "docs": "文档中心",
