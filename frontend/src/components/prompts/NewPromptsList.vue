      ...
      >
        ...
        <div class="flex justify-end">
            <el-form-item>
              ...
              <el-button
                :loading="loading"
                :class="showButton ? '!rounded-[8px] !text-center !h-9 !text-[16px] btn btn-primary': '!rounded-[8px] !text-center !h-9 !text-[16px] !bg-[#F2F4F7] !text-[#98A2B3]'"
                @click="handleSubmit"
              >
                {{ t('prompts.newList.createPrompts') }}
              </el-button>
            </el-form-item>
          </div>
      </el-form>
