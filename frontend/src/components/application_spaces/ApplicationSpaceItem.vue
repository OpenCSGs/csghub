<template>
  ...
  >
    <!-- Cover with Overlay -->
    <div class="relative bg-black h-[150px]">
      
    <!-- Decorative overlay -->
    <svg class="opacity-80 absolute -inset-4 w-[calc(100%+2rem)] h-[calc(100%+2rem)]" viewBox="0 0 412 150" fill="none" xmlns="http://www.w3.org/2000/svg" style="overflow: visible;">
      <defs>
        <filter id="blur-filter" x="-100%" y="-100%" width="300%" height="300%">
          <feGaussianBlur stdDeviation="64" />
        </filter>
      </defs>
      <g>
        <path 
          d="M411 60L411 142C411 146.418 407.418 150 403 150L8.99998 150C4.5817 150 0.999987 146.418 0.999988 142L0.999988 60C83.1626 -20 246.431 180 411 60Z"
          :class="[stableGradientColor]"
