<template>
  <div class="flex flex-col gap-[16px]">
    <div class="flex justify-between">
        <div @click="showDetail?showDetail=!showDetail:changeFlag('new')" class="px-[16px] py-[5px] border bg-gray-25 rounded-[4px] hover:bg-gray-100 text-gray-500 text-[14px] leading-[22px] cursor-pointer ">
          {{ showDetail? $t('community.discussion.back'):$t('community.discussion.new') }}
        </div>
        <!-- <div class="hover:bg-gray-100 cursor-pointer flex items-center gap-[8px] px-[16px] py-[5px] rounded-[4px] text-gray-500 text-[14px] leading-[22px]">
