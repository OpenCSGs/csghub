<template>
  <div class="min-h-[300px] py-8 md:px-5">
    <div class="flex items-center justify-between">
      ...
      <div v-if="lastCommit" class="flex items-center text-sm text-[#606266]">
        ...
        <a :href="`/${prefixPath}/${namespacePath}/commits`"
           class="ml-4 flex items-center px-4 py-[5px] border border-gray-200 rounded-[100px]">
    ...
    <div v-if="!loading" class="flex items-center justify-between min-h-[36px] mt-4 px-3 py-2 border border-gray-200 bg-[#F5F7FA] rounded-t-[4px]">
      <div v-if="lastCommit" class="flex items-center text-sm overflow-hidden mr-2">
        ...
        <a :href="`/${prefixPath}/${namespacePath}/commit/${lastCommit.id}`" class="rounded border border-gray-200 text-xs text-[#606266] px-3 py-[2px] hover:underline">
    ...
    <div v-if="files" v-for="file in files" class="flex items-center justify-between px-3 py-2 border border-t-0 border-gray-200 last-of-type:rounded-b-[4px]">
      ...
      <div class="flex items-center justify-end pr-3 text-sm text-[#606266] flex-shrink-0 text-right w-[20%] md:w-auto md:pr-0">
        ...
        <span v-if="file.lfs" class="flex items-center gap-1 text-xs text-gray-700 ml-2 rounded px-1 border border-[#909399]">
