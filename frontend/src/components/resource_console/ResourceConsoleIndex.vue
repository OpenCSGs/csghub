<template>
  <div class="w-full sm:mt-[36px] py-9 text-gray-900]">
    ...
    <h3 class="text-[18px] flex justify-between gap-[8px]">
      ...
      <a href="/finetune/new" class="cursor-pointer mx-[6px] flex gap-1 items-center py-2 px-3 text-[14px] leading-[20px] text-[#FFF] bg-brand-600] border border-brand-600] rounded-[8px]">
        <SvgIcon name="plus" />
    ...
    <h3 class="text-[18px] flex justify-between gap-[8px]">
      ...
      <a  href="/endpoints/new" class="cursor-pointer mx-[6px] flex gap-1 items-center py-2 px-3 text-[14px] leading-[20px] text-[#FFF] bg-brand-600] border border-brand-600] rounded-[8px]">
        <SvgIcon name="plus" />
        {{ $t('resourceConsole.new') }}
      </a>
    </h3>
