export const dataPipelines = {
  ...
  "taskManagementDescription": "任務管理可支持用戶使用多種不同的模型算子組成工作流，完成數據清洗、自動數據增強及分析等工作。",
  "taskTemplate": "任務模板",
  "templateName": "模板名稱",
  ...
  "semanticDeduplication": "語義去重",
  "qualityEvaluation": "質量評測",
  "taskManagement": "任務管理",
  "builtInTaskTemplate": "內置任務模板",
  "customTaskTemplate": "自定義任務模板",
  "securityScan": "安全掃描",
  ...
  "toolParam": {
    ...
    "chunk_size": "分塊大小",
    "overlap": "重疊大小",
    "min_sentences_per_chunk": "每個分塊最少句子數",
    "generate_meta_log": "生成元數據日誌",
    "web_text_max_len": "網頁文本最大長度",
    "model": "模型",
    "content": "內容",
    "suffixes": "文件後綴",
    "url": "URL",
    ...
    "topk": "Top K",
    "is_tsv": "是否為TSV格式",
    "keep_default_na": "保留默認NA值",
    "serialized_key": "序列化鍵",
    "tokenizer_method": "分詞器方法",
    "weights": "權重",
    "max_samples": "最大樣本數",
    "embedding_model_url": "嵌入模型URL",
    "embedding_model_name": "嵌入模型名稱",
    "embedding_auth_token": "嵌入認證令牌",
