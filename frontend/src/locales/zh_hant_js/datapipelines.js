export const dataPipelines = {
  ...
  "taskAttribute": "任務所屬",
  "namespaceLoading": "任務所屬資訊載入中，請稍候",
  "taskScopePersonal": "個人",
  "taskScopeOrganization": "組織",
  "pleaseSelectOrganization": "請選擇組織",
  "noOrganizationNamespace": "當前帳號暫無可選組織",
  "namespaceLoadFailed": "任務所屬資訊載入失敗，請重新整理頁面後重試",
  "selectRegion": "選擇區域",
  "spaceCloudResources": "空間雲資源",
  "storageSize": "存儲大小",
  "storageSizeHint": "可從列表選擇或輸入數字，提交時自動轉換為 Gi 單位",
  "region": "區域",
  "subtaskCount": "子任務數",
  "viewSubtasks": "查看子任務",
  "subtaskHarvestingMysql": "數據採集-MySQL",
  "subtaskHarvestingMongodb": "數據採集-MongoDB",
  "subtaskHarvestingHive": "數據採集-Hive",
  "subtaskHarvestingFile": "數據採集-文件",
  "subtaskUploadData": "數據上傳",
  "subtaskPullData": "數據拉取",
  "subtaskFormatConversion": "格式轉換",
  "subtaskFormatConversionFromTo": "格式轉換-{from}轉{to}",
  "subtaskToolExecute": "數據處理-算子執行",
  "subtaskOperatorExecute": "數據處理-算子執行",
  "subtaskIdentifier": "標識",
  "executionResult": "執行結果",
  "executionEnded": "執行結束",
  "mockSubtaskName": "子任務一",
  "resourceTabCpu": "CPU",
  "resourceTabGpu": "GPU",
  ...
  "document": "文檔",
  "uploadDocument": "算子描述文檔",
  "documentPreview": "文檔預覽",
  "operatorIntroduction": "算子介紹",
  "documentUploadTips1": "支持上傳 Markdown (.md) 格式文檔",
  "documentUploadTips3": "支持 .md 格式文件",
  "confirmDeleteDocument": "確定要刪除該文檔嗎？",
  "tips": "提示",
  "documentUploadError1": "只能上傳 Markdown 格式文件",
  "documentUploadError2": "文件大小不能超過 10MB",
  "submitting": "保存中",
  ...
  "md_to_jsonl_preprocess_internal_dec": "使用分塊支持將MD文件轉換為JSONL格式。",
  "modelNotAvailable": "此模型不可用",
  "searchingModel": "正在驗證模型...",
  "searchSelectHint": "支持輸入模型名稱進行遠程搜索",
  "selectModel": "選擇模型",
  "moreModels": "更多模型",
  "searchModelName": "搜索模型名稱",
  "fetchModelListError": "獲取模型列表失敗",
}