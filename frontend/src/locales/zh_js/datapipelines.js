export const dataPipelines = {
  ...
  "taskManagementDescription": "任务管理可支持用户使用多种不同的模型算子组成工作流，完成数据清洗、自动数据增强及分析等工作。",
  "taskTemplate": "任务模板",
  "templateName": "模板名称",
  ...
  "qualityEvaluation": "质量评测",
  "taskManagement": "任务管理",
  "builtInTaskTemplate": "内置任务模板",
  "customTaskTemplate": "自定义任务模板",
  "securityScan": "安全扫描",
  ...
  "toolParam": {
    ...
    "chunk_size": "分块大小",
    "overlap": "重叠大小",
    "min_sentences_per_chunk": "每个分块最少句子数",
    "generate_meta_log": "生成元数据日志",
    "web_text_max_len": "网页文本最大长度",
    "model": "模型",
    "content": "内容",
    "suffixes": "文件后缀",
    "url": "URL",
    ...
    "topk": "Top K",
    "is_tsv": "是否为TSV格式",
    "keep_default_na": "保留默认NA值",
    "serialized_key": "序列化键",
    "tokenizer_method": "分词器方法",
    "weights": "权重",
    "max_samples": "最大样本数",
    "embedding_model_url": "嵌入模型URL",
    "embedding_model_name": "嵌入模型名称",
    "embedding_auth_token": "嵌入认证令牌",
