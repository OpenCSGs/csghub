export const dataPipelines = {
  ...
  "toInput": "请输入",
  "dataOwner": "数据所有者",
  "inputTagHint": "按 Enter 键添加关键字，可添加多个关键字",
  "textareaArrayDataHint": "每行输入一个正则表达式，换行表示新的正则",
  "noData": "暂无数据",
  ...
  "ServerAddress": "服务器地址",
  "port": "端口号",
  "portInvalidFormat": "端口格式不正确，请输入有效端口号",
  "portOutOfRange": "端口号超出范围，请输入 1-65535 之间的端口号",
  "username": "用户名",
  "password": "密码",
  "authType": "鉴权类型",
  ...
  "taskAttribute": "任务所属",
  "namespaceLoading": "任务所属信息加载中，请稍候",
  "taskScopePersonal": "个人",
  "taskScopeOrganization": "组织",
  "pleaseSelectOrganization": "请选择组织",
  "noOrganizationNamespace": "当前账号暂无可选组织",
  "namespaceLoadFailed": "任务所属信息加载失败，请刷新页面后重试",
  "selectRegion": "选择区域",
  "spaceCloudResources": "空间云资源",
  "storageSize": "存储大小",
  "storageSizeHint": "支持从列表选择或输入数字，提交时自动转换为 Gi 单位",
  "region": "区域",
  "subtaskCount": "子任务数",
  "viewSubtasks": "查看子任务",
  "subtaskHarvestingMysql": "数据采集-MySQL",
  "subtaskHarvestingMongodb": "数据采集-MongoDB",
  "subtaskHarvestingHive": "数据采集-Hive",
  "subtaskHarvestingFile": "数据采集-文件",
  "subtaskUploadData": "数据上传",
  "subtaskPullData": "数据拉取",
  "subtaskFormatConversion": "格式转换",
  "subtaskFormatConversionFromTo": "格式转换-{from}转{to}",
  "subtaskToolExecute": "数据处理-算子执行",
  "subtaskOperatorExecute": "数据处理-算子执行",
  "subtaskIdentifier": "标识",
  "executionResult": "执行结果",
  "executionEnded": "执行结束",
  "mockSubtaskName": "子任务一",
  "resourceTabCpu": "CPU",
  "resourceTabGpu": "GPU",
  ...
  "document": "文档",
  "uploadDocument": "算子描述文档",
  "documentPreview": "文档预览",
  "operatorIntroduction": "算子介绍",
  "documentUploadTips1": "支持上传 Markdown (.md) 格式文档",
  "documentUploadTips3": "支持 .md 格式文件",
  "confirmDeleteDocument": "确定要删除该文档吗？",
  "tips": "提示",
  "documentUploadError1": "只能上传 Markdown 格式文件",
  "documentUploadError2": "文件大小不能超过 10MB",
  ...
  "md_to_jsonl_preprocess_internal": "MD转JSONL工具",
