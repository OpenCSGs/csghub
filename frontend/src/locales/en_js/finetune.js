export const finetune = {
  ...
  new: {
    ...
    resourceDec1: 'You can switch to different compute resources within the space settings at any time',
    ...
    balanceInsufficient: 'Insufficient balance, unable to run resources',
    taskBalanceInsufficient: 'Your current balance is insufficient to create tasks. Your current balance is {balance}. Please recharge to continue using the service and ensure tasks run smoothly.',
  },
  detail: {
    ...
    settings: {
      ...
      resourcesTip1: 'You can switch to different compute resources.',
      resourcesTip2: 'Switching to paid resources will incur charges based on the usage duration.',
      resourcesTip3: 'Current Compute Resources',
