export const prompts = {
  ...
  variablePlayground: "Variable Playground",
  variablePlaygroundDesc: "Fill in values for the template variables to preview and copy the customized prompt.",
  detectedVariables: "Detected Variables",
  variable: "Variable",
  enterValue: "Enter value for",
  substitutedPreview: "Substituted Preview",
  copySubstituted: "Copy Substituted Prompt",
  resetVariables: "Reset",
  copySubstitutedSuccess: "Substituted prompt copied to clipboard!",
  tag: {
