export const dataPipelines = {
  ...
  "sessionProcessedResult": "Processing Result",
  "index": "Index",
  "preSession": "Before Processing",
  "processType": "Processing Method",
  "afterSession": "After Processing",
  "taskLog": "Task Log",
  "logName": "Log Name",
  ...
  "taskManagementDescription": "Task Management allows users to build workflows using various model operators, enabling tasks such as data cleaning, automated data augmentation, and analysis.",
 ...
 "raw_arxiv_to_jsonl_preprocess_internal": "raw arxiv to jsonl preprocess",
  ...
  "dataDesensitization": "Data Desensitization",
  "semanticDeduplication": "Semantic Deduplication",
  "qualityEvaluation": "Quality Evaluation",
  "taskManagement": "Task Management",
  "builtInTaskTemplate": "Built-in Task Template",
  "customTaskTemplate": "Custom Task Template",
  "securityScan": "Security Scan",
  
  // Tool parameter name internationalization
  "toolParam": {
    ...
    "hf_tokenizer": "Select Model",
    "chunk_size": "Chunk Size",
    "overlap": "Overlap",
    "min_sentences_per_chunk": "Min Sentences Per Chunk",
    "generate_meta_log": "Generate Meta Log",
    "web_text_max_len": "Web Text Max Length",
    "model": "Model",
    "content": "Content",
    ...
    "prompt": "Prompt",
    "topk": "Top K",
    "is_tsv": "Is TSV Format",
    "keep_default_na": "Keep Default NA",
    ...
    "embedding_auth_token": "Embedding Auth Token",
