export const dataPipelines = {
  ...
  "taskAttribute": "task ownership",
  "namespaceLoading": "Loading task ownership, please wait",
  "taskScopePersonal": "Personal",
  "taskScopeOrganization": "Organization",
  "pleaseSelectOrganization": "Please select an organization",
  "noOrganizationNamespace": "No organization namespaces available",
  "namespaceLoadFailed": "Failed to load task namespace. Please refresh and try again.",
  "selectRegion": "Select region",
  "spaceCloudResources": "Space cloud resources",
  "storageSize": "Storage size",
  "storageSizeHint": "Choose a preset or enter a number; values are submitted in Gi",
  "region": "Region",
  "subtaskCount": "Subtasks",
  "viewSubtasks": "View subtasks",
  "subtaskHarvestingMysql": "Data Acquisition-MySQL",
  "subtaskHarvestingMongodb": "Data Acquisition-MongoDB",
  "subtaskHarvestingHive": "Data Acquisition-Hive",
  "subtaskHarvestingFile": "Data Acquisition-File",
  "subtaskUploadData": "Data Upload",
  "subtaskPullData": "Data Pull",
  "subtaskFormatConversion": "Format Conversion",
  "subtaskFormatConversionFromTo": "Format Conversion-{from} to {to}",
  "subtaskToolExecute": "Data Processing-Operator",
  "subtaskOperatorExecute": "Data Processing-Operator",
  "subtaskIdentifier": "ID",
  "executionResult": "Execution result",
  "executionEnded": "Execution finished",
  "mockSubtaskName": "Subtask 1",
  "resourceTabCpu": "CPU",
  "resourceTabGpu": "GPU",
  ...
  "uploadSuccessTips1": "You can continue to click to upload and replace.",
  "reUpload": "Re-upload",
  ...
  "document": "Document",
  "uploadDocument": "Operator Description Document",
  "documentPreview": "Document Preview",
  "operatorIntroduction": "Operator Introduction",
  "documentUploadTips1": "Supports uploading Markdown (.md) format documents",
  "documentUploadTips3": "Supports .md format files",
  "confirmDeleteDocument": "Are you sure you want to delete this document?",
  "tips": "Tips",
  "documentUploadError1": "Only Markdown format files are allowed",
  "documentUploadError2": "File size cannot exceed 10MB",
