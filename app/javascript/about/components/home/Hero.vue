<template>
  <div class="bg-white pb-[80px] md:pb-0">
    <div
      ...
      <div class="h-auto">
        <img :src="hero" class="w-[600px]" alt="OpenCSG"/>
      </div>
      <div class="xl:flex xl:flex-col xl:items-center">
        ...
        <div class="text-[20px] leading-[28px] text-[#60626] mb-[24px] md:text-[14px]">{{ $t('home.headDesc') }}</div>
        <div class="flex gap-[8px]">
          <a href="https://portal.opencsg.com/" target="_blank"
             class="flex w-[200px] h-[48px] justify-center items-center rounded-[40px] text-[#fff] bg-[#000] text-[20px] leading-[28px] font-semibold no-underline">{{
              $t('JoinC')
            }}</a>
        </div>
      </div>
