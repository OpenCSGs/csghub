...
const activities = [
  {
    contentList: [
      t('landingPage.company.content1'),
    ],
    timestamp: t('landingPage.company.timestamp1'),
  },
  {
    contentList: [t('landingPage.company.content2')],
  ...
  {
    contentList: [
      t('landingPage.company.content4-1'),
      t('landingPage.company.content4-2')
    ],
    timestamp: t('landingPage.company.timestamp4'),
  },
  {
    contentList: [
      t('landingPage.company.content5'),
    ],
    timestamp: t('landingPage.company.timestamp5'),
  },
]
</script>
