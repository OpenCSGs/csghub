  ...
  <div class="KnowledgeBase py-[96px] text-center w-full bg-white">
    <div class="max-w-[1280px] m-auto">
      <div class="flex flex-col items-center md:px-[20px] mb-[64px]">
        ...
        <div class="my-[20px] max-w-[768px] text-[20px] text-[#606266] leading-[30px] font-light">EKB AI 将文档结构化并转换为数字资产，实现信息数字化存储和管理，夯实企业资产的数字化转型基础。</div>
        ...
        <div class="text-[14px] leading-[20px] text-[#223B99] mt-[16px]">暂不开放注册，请联系 contact@opencsg.com 获取试用权限</div>
      </div>
