<template>
  <div v-if="dialogVisible" class="mt-2 min-w-[438px] bg-white p-6 md:p-1 rounded-md shadow-md md:min-w-[340px] md:w-full z-20 relative">
    ...
    <div class="w-full h-full min-h-[600px] md:min-h-[400px] overflow-hidden">
