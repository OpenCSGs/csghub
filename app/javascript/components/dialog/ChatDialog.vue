<template>
  <div v-if="dialogVisible" class="h-[75vh] fixed flex flex-col justify-between top-2 right-0 mt-2 min-w-[438px] bg-white p-6 md:p-1 rounded-md shadow-md md:min-w-[300px] md:w-full z-20 border border-[[#EAECF0]]">
