      ...
      <div class="mb-9 text-sm w-full">
        ...
        <div class="flex gap-[24px] mt-9 sm:flex-col">
          <div class="flex items-center justify-center flex-col border-[2px] rounded-[8px] p-[36px] cursor-pointer"
            ...
            <svg v-if="SDK !== 'gradio'" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12.5344 2.97266L21.4997 7.88955V10.7543L12.5344 5.83742V2.97266Z" fill="#D0D5DD"/><path d="M21.4962 7.88867L12.498 12.8241V15.7073L21.4962 10.7719V7.88867Z" fill="#D0D5DD"/><path d="M3.5 7.88867L12.499 12.8241V15.7073L3.5 10.7719V7.88867Z" fill="#D0D5DD"/><path d="M12.5347 2.95508L3.50195 7.89042V10.7736L12.5347 5.8383V2.95508Z" fill="#D0D5DD"/><path d="M12.5344 7.94531L21.4997 12.8622V15.7269L12.5344 10.8101V7.94531Z" fill="#D0D5DD"/><path d="M21.4967 12.8613L12.4985 17.7967V20.6799L21.4967 15.7446V12.8613Z" fill="#D0D5DD"/><path d="M3.5 12.8613L12.499 17.7967V20.6799L3.5 15.7446V12.8613Z" fill="#D0D5DD"/><path d="M12.5347 7.92578L3.50195 12.8611V15.7443L12.5347 10.809V7.92578Z" fill="#D0D5DD"/>
            </svg>

            <svg v-if="SDK === 'gradio'" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="flex items-center justify-center flex-col border-[2px] rounded-[8px] p-[36px] cursor-pointer"
               ...
               @click="SDK = 'streamlit'">
            <svg v-if="SDK !== 'streamlit'" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg v-if="SDK === 'streamlit'" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_6758_265504)"><path d="M12.5185 13.5188L8.32512 11.3022L1.04602 7.45502C1.03933 7.4484 1.02609 7.4484 1.01939 7.4484C0.753638 7.3221 0.481186 7.58793 0.580854 7.85369L4.28985 17.3135L4.29049 17.3155C4.29447 17.3248 4.29782 17.3341 4.30181 17.3434C4.45402 17.6962 4.7862 17.9142 5.14771 17.9999C5.17825 18.0066 5.2001 18.0125 5.23677 18.0199C5.27337 18.028 5.32448 18.0391 5.36834 18.0424C5.37551 18.0431 5.38221 18.0431 5.38954 18.0437H5.39489C5.40015 18.0444 5.40549 18.0444 5.41083 18.0451H5.41809C5.42279 18.0457 5.42806 18.0457 5.43276 18.0457H5.44137C5.44671 18.0464 5.45198 18.0464 5.45732 18.0464C10.1546 18.5586 14.8936 18.5586 19.5909 18.0464C19.6474 18.0464 19.7026 18.0437 19.7557 18.0385L19.8062 18.0325C19.8082 18.0318 19.8108 18.0318 19.8128 18.0311C19.8242 18.0298 19.8354 18.0278 19.8467 18.0258C19.8633 18.0238 19.88 18.0205 19.8965 18.0172C19.9298 18.0098 19.9449 18.0046 19.99 17.989C20.035 17.9736 20.1099 17.9464 20.1567 17.9239C20.2036 17.9013 20.2361 17.8796 20.2753 17.8551C20.3237 17.8247 20.3709 17.7923 20.4167 17.7581C20.4369 17.7426 20.4507 17.7328 20.4653 17.7188L20.4573 17.7142L12.5185 13.5188Z" fill="#FF4B4B"/><path d="M24.003 7.45495H23.9964L16.7146 11.3021L20.7625 17.3308L24.4621 7.85362V7.84031C24.5552 7.56124 24.2695 7.3088 24.003 7.45495Z" fill="#7D353B"/><path d="M12.9064 5.62574C12.7203 5.35392 12.315 5.35392 12.1356 5.62574L8.32495 11.3022L12.5183 13.5188L20.4652 17.7187C20.5151 17.6698 20.5551 17.6222 20.5974 17.5719C20.6593 17.4965 20.7144 17.4158 20.7622 17.3307L16.7143 11.3022L12.9064 5.62574Z" fill="#BD4043"/></g><defs><clipPath id="clip0_6758_265504"><rect width="24" height="24" fill="white" transform="translate(0.5)"/></clipPath></defs>
            </svg>
