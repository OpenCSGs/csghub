    ...
    <div class="mt-9">
      <div class="w-full flex sm:flex-col gap-2 mb-9 md:gap-9">
        ...
        <div class="flex-1">
          ...
          <el-input v-model="codeName" :placeholder="$t('application_spaces.new.namePlaceholder')" input-style="width: 100%" >
            <template #suffix>
              <el-tooltip class="item" effect="dark" :content="$t('application_spaces.new.tip')" placement="top">
