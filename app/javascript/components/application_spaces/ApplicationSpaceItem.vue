<template>
  <a :href="`/spaces/${repo.path}`" class="focus:outline focus:outline-4 focus:outline-[#EAECF0] hover:shadow-md border border-gray-200 rounded-xl p-4 w-full mlg:w-full" :class="`width ? w-[${width}px] : ''`">
