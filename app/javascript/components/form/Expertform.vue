<template>
  <div class="flex justify-center items-center mt-[200px] lg:mt-[350px]">
    <div
      ...
      <div v-if="divVisible === true" class="flex items-center justify-center px-[16px] py-[9px] w-full font-normal text-[13px] text-[#909399] rounded-[4px] leading-[22px] outline-0 bg-[#F4F4F5] gap-[8px]">
