<template>
  <div class="flex justify-center items-center mt-[50px] lg:mt-[60px] md:mt-[60px] sm:mt-[36px] md:px-[24px]">
    <div class="flex flex-col bg-white w-[500px] md:w-[400px] h-auto border rounded-lg p-[36px] md:p-[24px] md:pt-[8px] border-[#DCDFE6] bg-gradient-to-r shadow-xl">
      ...
      <div>
        <div class="hidden md:block text-sm text-[#606266] mb-[24px]">
          <p class="mt-[16px]">开放传神（OpenCSG）邀请您入驻专家社区，让我们共建开源开放、共享开源生态。希望您为用户提供技术支持及咨询，解决方案设计指导等。</p>
          <p class="mt-[16px]">您可以是人工智能专家，软件开发专家，开源专家，算法专家，法务专家等。诚挚的欢迎您入驻专家社区。</p>
        </div>
