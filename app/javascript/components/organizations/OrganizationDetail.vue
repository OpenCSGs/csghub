      ...
      <div class="max-w-[1280px] m-auto py-[36px] flex sm:flex-col">
        <div class="w-[30%] md:w-[45%] px-[16px] sm:w-[100%]">
          ...
          <el-dialog
            ...
            width="350"
          >
            <span>你正在邀请新成员到组织 <span class="font-bold">{{ organization.name }}</span></span>
            <div class="mt-[20px]">
              <div class="mb-[20px]">
                <p class="text-[#344054] text-[14px] mb-[6px]">用户名</p>
                <el-input v-model="userNameInput" placeholder="Please input" />
              </div>
              <div>
                <p class="text-[#344054] text-[14px] mb-[6px]">角色</p>
                <el-select v-model="userRoleInput" placeholder="Select" class="w-full h-[40px]">
                  <el-option
