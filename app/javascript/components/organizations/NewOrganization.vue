  ...
  <div class="rounded-[16px] bg-white p-[36px]">
    ...
    <div class="mt-[16px]">
      <div class="flex sm:flex-col gap-[16px] mb-[16px]">
        ...
        <div class="w-[284px] sm:w-auto">
          <p class="text-[#303133] text-[14px] mb-[8px]">{{ $t('organization.orgNickName') }}</p>
          <el-input v-model="orgNickname" :placeholder="this.$t('all.inputPls')" input-style="height: 40px" />
        </div>
      </div>
      <div class="flex sm:flex-col gap-[16px] mb-[16px]">
        <div class="max-w-[284px]">
          <p class="text-[#303133] text-[14px] mb-[8px]">{{ $t('organization.orgAvatar') }}</p>
          <div>
      ...
      <div class="mb-[16px]">
        <p class="text-[#303133] text-[14px] mb-[8px]">{{ $t('organization.orgHomepage') }}</p>
