<template>
  <div class="text-center w-full bg-white">
    <div class="max-w-[1280px] m-auto py-[96px]">
      <div
        class="m-auto text-[60px] md:text-[48px] md:leading-[60px] text-[#101828] leading-[72px]"
      >
        {{ $t("ekb.title") }}
      </div>
      <div
        class="m-auto mb-[24px] font-semibold text-[60px] md:text-[36px] leading-[72px] md:leading-[50px] bg-clip-text text-transparent bg-gradient-to-r from-[#2E1492] via-[#B73FA9] to-[#A45FE6]"
      >
        {{ $t("ekb.desc") }}
      </div>
      <div
        class="text-[20px] mb-[24px] font-light text-[#475467] leading-[30px]"
      >
        {{ $t("ekb.tips") }}
      </div>
