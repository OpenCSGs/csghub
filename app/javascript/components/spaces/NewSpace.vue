  ...
  <div class="w-[640px] m-auto flex flex-col items-center md:w-full md:p-5">
    ...
    <div class="mt-9">
      ...
      <div class="w-full flex sm:flex-col mb-9">
        <div class="flex-1">
          ...
          <el-upload
              ...
              :data="{ owner: owner, modelName: modelName, modelNickName: modelNickName, license: license, modelDesc: modelDesc, visibility: visibility}"
              :auto-upload="false"
      ...
      <div class="mb-9 text-sm w-full">
        ...
        <div class="flex gap-[24px] mt-9">
          <div class="flex items-center justify-center flex-col border-[2px] rounded-[8px] p-[36px] cursor-pointer" :class="SDK === 'Gradio' ? 'border-[#3250BD] text-[#344054]' : 'text-[#D0D5DD]'">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12.0344 2.97314L20.9997 7.89004V10.7548L12.0344 5.8379V2.97314Z" fill="#FF7C00" fill-opacity="0.75"/>
              ...
              <path d="M12.0344 7.94482L20.9997 12.8617V15.7264L12.0344 10.8096V7.94482Z" fill="#FF7C00" fill-opacity="0.75"/>
