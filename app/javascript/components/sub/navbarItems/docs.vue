<template>
  <el-popover
    ...
    :width="200"
    trigger="hover"
    content="OpenCSG DocCenter Coming Soon!"
  >
    <template #reference>
      <div class="flex items-center hover:text-[#00b8e6]">
  ...
  <!-- <a href="https://docs.opencsg.com" class="flex items-center hover:text-[#00b8e6]">
  </a> -->
</template>