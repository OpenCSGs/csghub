<template>
  <div
    class="flex top-navbar-menu text-[#303133] justify-between items-center max-w-[1280px] m-auto xl:mx-[20px] h-[80px] sm:h-[60px]">
    <div class="flex">
      <div class="py-2 mr-[50px] xl:mr-[50px] sm:mr-[30px]">
        <a href="/">
          <img
            :src="logo"
            alt="OpenCSG Logo"
            class="w-[135px] sm:w-[90px] sm:hidden" />
          <img
            src="/images/opencsg_mobile_logo.png"
            alt="OpenCSG Logo"
            class="hidden w-auto h-[40px] sm:block" />
        </a>
      </div>
    </div>
    <div class="flex items-center justify-end gap-4 w-full md:gap-0 xl:w-[30%]">
      <el-menu
        ...
        <el-menu-item
          index="/models"
          style="border: none"
          @click="routerLink('/models')"
          >{{ $t('navbar.models') }}</el-menu-item
        >
        ...
        <el-menu-item
          index="/datasets"
          style="border: none"
          @click="routerLink('/datasets')"
          >{{ $t('navbar.datasets') }}</el-menu-item
        >
        ...
        <el-menu-item
          index="/codes"
          style="border: none"
          @click="routerLink('/codes')"
          >{{ $t('navbar.codes') }}</el-menu-item
        >
        ...
        <el-menu-item
          index="/spaces"
          style="border: none"
          @click="routerLink('/spaces')"
          >{{ $t('navbar.spaces') }}</el-menu-item
        >
        ...
        <el-menu-item
          index="/collections"
          style="border: none"
          @click="routerLink('/collections')"
          >{{ $t('collections.collection') }}</el-menu-item
        >
        ...
        <el-menu-item
          index="/computing"
          style="border: none"
          @click="routerLink('/computing')"
          >{{ $t('navbar.computer') }}</el-menu-item
        >
        ...
        <el-sub-menu
          ...
          <el-menu-item
            style="height: auto"
            @click="routerLink('/csghub')"
            index="CsgHub">
            <ProductCsgHub />
          </el-menu-item>
          <el-menu-item
            style="height: auto"
            @click="routerLink('/starship')"
            index="StarShip">
            <StarShip />
          </el-menu-item>
          <el-menu-item
            style="height: auto"
            @click="routerLink('/ekb')"
            index="KnowledgeBase">
            <EKB />
          </el-menu-item>
          <el-menu-item
            style="height: auto"
            @click="handleNavigation('/solution', 'StarAIO')"
            index="StarAIO">
            <StarAIO />
          </el-menu-item>
          <el-menu-item
            style="height: auto"
            @click="handleNavigation('/solution', 'AIImg')"
            index="AIImg">
            <Imagen />
          </el-menu-item>
          <el-menu-item
            style="height: auto"
            @click="handleNavigation('/solution', 'Programming')"
            index="Programming">
            <StarCode />
          </el-menu-item>
          <el-menu-item
            style="height: auto"
            @click="handleNavigation('/solution')"
            index="Programming">
            <AllSolution />
          </el-menu-item>
        </el-sub-menu>
        ...
        <el-sub-menu
          ...
          <a
            ...
            ><el-menu-item
              style="height: auto"
              index="3-3"
              ><LlmFinetune /></el-menu-item
          ></a>
          <a
            :href="OpenSourceStarCloudUrl"
            target="_blank"
            ><el-menu-item
              style="height: auto"
              index="3-4"
              ><OpenSourceStarCloud /></el-menu-item
          ></a>
          <a
            :href="starChainUrl"
            target="_blank"
      ...
      <button
        v-else
        class="min-w-[72px] sm:min-w-[46px] bg-[#303133] rounded-[100px] p-[2px] flex items-center justify-center text-[12px] font-500 text-white leading-[20px]">
        <a
          class="sm:hidden"
          href="/login">
          {{ $t('navbar.register') }}
