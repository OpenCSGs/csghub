<template>
  <div class="flex items-center flex-wrap gap-2 pl-4 py-4 mt-4 md:pl-0 md:pb-0 z-10 border-t border-[#EBEEF5]">
    <div class="rounded border border-[#DCDFE6] flex items-center justify-center px-4 py-[5px] cursor-pointer hover:bg-[#F9FAFB]" @click="dialogLibraryVisible = true">
    ...
    <div class="rounded border border-[#DCDFE6] flex items-center justify-center px-4 py-[5px] cursor-pointer hover:bg-[#F9FAFB]" @click="cloneRepositoryVisible = true">
      ...
      <div class="ml-2 text-[#606266] text-sm font-medium">下载数据集</div>
    </div>
