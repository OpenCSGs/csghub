<template>
  <div class="flex items-center pl-4 py-4 mt-4 md:pl-5 md:pb-4 z-10 border-t border-[#EBEEF5]">
    <div class="rounded border border-[#DCDFE6] flex items-center justify-center px-4 py-[5px] cursor-pointer mr-2" @click="dialogLibraryVisible = true">
      ...
      <div class="ml-2 text-[#606266] font-medium">Use in dataset library</div>
    </div>
    <div class="rounded border border-[#DCDFE6] flex items-center justify-center px-4 py-[5px] cursor-pointer" @click="cloneRepositoryVisible = true">
      ...
      <div class="ml-2 text-[#606266] font-medium">Clone repository</div>
    </div>
    <el-dialog v-model="dialogLibraryVisible" title="Dataset library is unknown">
