<template>
  <div class="flex items-center gap-[8px] flex-wrap mb-5 text-xl text-[#606266] font-semibold md:px-5">
  ...
  <div class="flex gap-[8px] items-center mb-5 text-lg text-[#606266] font-light md:px-5 flex-wrap">
