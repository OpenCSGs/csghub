<template>
  <div class="flex items-center gap-[8px] flex-wrap mb-5 text-lg text-[#606266] font-semibold md:px-5">
    <div>
      <div class="mb-[16px] flex gap-[8px] items-center items-center md:w-full md:mb-1">
