<template>
  <div class="border border-[#DCDFE6] rounded-[8px] my-[32px] md:my-0 md:border-none px-[24px] py-[24px]">
    <div class="flex flex-col gap-[8px]">
      ...
      <div class="max-w-[864px] ml-[36px] text-[14px] text-[#606266] leading-[22px]">This dataset is currently <span
          class="text-black font-semibold">【{{ visibility }}】</span>. Only you (personal dataset) or members of your
        organization (organization dataset) can see and commit to this dataset.
      </div>
    ...
    <div class="flex flex-col gap-[8px]">
      ...
      <div class="ml-[36px] text-[14px] text-[#606266] leading-[22px]">This action <span
          ...
          class="text-black font-semibold">{{ path }}</span> dataset repository and all its files.
      </div>
