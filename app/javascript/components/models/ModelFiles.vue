<template>
  <div class="min-h-[300px] pt-8 sm:px-5">
    ...
    <div v-for="file in files" class="flex items-center justify-between px-3 py-2 border border-[#DCDFE6] last-of-type:border-t-0 last-of-type:rounded-b-[4px] last-of-type:rounded-l-[4px]">
