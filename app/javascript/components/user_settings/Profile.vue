<template>
  <div class="max-w-[400px] pl-[20px] pr-[40px] md:px-0 sm:px-0 sm:w-full py-[36px]">
    <!-- avatar -->
    <div>
      <el-avatar :size="160" :src="userStore.avatar"></el-avatar>
    </div>
    <!-- nickname -->
    ...
    <!-- profile settings -->
    <div v-if="userStore.isLoggedIn" class="flex xl:flex-col md:flex-row gap-3">
    ...
    <!-- email -->
    <div v-if="userStore.isLoggedIn && userStore.email"
         class="mt-[16px] text-[#606266] text-[16px] leading-[24px] flex items-center gap-[8px]">
      ...
      <div class="w-[90%] overflow-hidden text-ellipsis">{{ userStore.email }}</div>
    </div>
    <!-- last login time -->
    <div v-if="userStore.isLoggedIn && userStore.lastLoginTime"
         class="mt-[16px] text-[#606266] text-[16px] leading-[24px] flex items-center gap-[8px]">
