<template>
  <div class="max-w-[400px] min-w-[300px] pl-[20px] pr-[40px] md:px-0 sm:px-0 sm:w-full py-[36px]">
    ...
    <div v-if="isLoggedIn" class="flex xl:flex-col md:flex-row gap-3">
      ...
      <a :href="`/profile/likes/${ name }`" class="px-[12px] py-[5px] lg:w-[200px] md:w-auto text-center border border-[#DCDFE6] rounded-[4px] text-[14px] leading-[22px] font-medium hover:bg-[#EAECF0] hover:text-[#808080]">
        {{ $t('profile.myCollect')}}
      </a>
    </div>
