<template>
  <div class="xl:px-[16px] sm:w-[100%] sm:mt-[36px]">
    ...
    <div>
      ...
      <div v-if="hasModels" class="grid grid-cols-2 xl:grid-cols-1 gap-4 mb-4 mr-6 mt-[16px]">
    ...
    <div class="mt-[32px]">
      ...
      <div v-if="hasDatasets" class="grid grid-cols-2 xl:grid-cols-1 gap-4 mb-4 mr-6 mt-[16px]">
    ...
    <div class="mt-[32px]">
      ...
      <div v-if="hasCodes" class="grid grid-cols-2 xl:grid-cols-1 gap-4 mb-4 mr-6 mt-[16px]">
