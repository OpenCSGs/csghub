<template>
  <div class="flex flex-col gap-[8px] flex-wrap mb-5 text-lg text-[#606266] font-semibold md:px-5">
    <div v-if="repoType === 'dataset'"
      ...
      private ? $t("all.private") : $t("all.public") }}</div>
      <div
        ...
        :class="repoHasLike === true ? 'text-gray-400 border-gray-200' : ''" @click="addLike">
    ...
    <div class="flex gap-[8px] items-center">
      ...
      <div class="cursor-pointer" @click="copyName"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
  ...
  <header-tags :task-tags="tags.task_tags" :framework-tags="tags.framework_tags" :license-tags="tags.license_tags"
