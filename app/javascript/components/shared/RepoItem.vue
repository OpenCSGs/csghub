<template>
  <a :href="detailLink"
    ...
    <p v-if="getComputed.showDescription" class="h-[35px] w-[390px] text-left overflow-hidden sm:w-auto leading-[18px] mb-[5px] text-[#909399] text-xs overflow-hidden overflow-ellipsis line-clamp-2">
      {{ repo.description }}
    </p>
