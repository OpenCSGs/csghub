<template>
  <div class="flex items-center flex-wrap gap-4 md:px-5 md:mb-[30px] md:flex-col md:items-start">
    ...
    <div v-for="tag in taskTags" class="text-sm text-[#303133] px-[8px] py-[4px] rounded cursor-pointer flex items-center gap-1 bg-[#d3d3d354]" :style="`color: ${tag.color}`">
    ...
    <div v-for="tag in licenseTags" class="text-sm text-[#303133] px-[8px] py-[4px] rounded cursor-pointer flex items-center border gap-1">
