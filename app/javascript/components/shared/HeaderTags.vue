<template>
  <div class="flex items-center flex-wrap gap-4 md:px-5 md:mb-[30px] md:flex-col md:items-start">
    ...
    <MoreTags v-if="taskTags.length > 3" :num="taskTags.length - 3" target="task" />
    <!-- Framework -->
    ...
    <MoreTags v-if="frameworkTags.length > 3" :num="frameworkTags.length - 3" target="framework" />
    <!-- Language -->
    ...
    <MoreTags v-if="languageTags.length > 3" :num="languageTags.length - 3" target="language" />
    <!-- industryTags -->
    ...
    <MoreTags v-if="industryTags.length > 3" :num="industryTags.length - 3" target="industry" />
    <!-- Other -->
    ...
    <MoreTags v-if="otherTags.length > 3" :num="otherTags.length - 3" target="other" />
    <!-- License -->
    ...
    <MoreTags v-if="licenseTags.length > 3" :num="licenseTags.length - 3" target="license" />
  </div>
</template>
