<template>
    <a :href="`/profile/${ name }`" class="flex items-center w-[150px] mr-[10px] px-[12px] py-[5px] border border-[#DCDFE6] rounded-[4px] text-[14px] leading-[22px] font-medium hover:bg-[#EAECF0] hover:text-[#808080]">
      <svg class="mr-[4px]" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.08366 4.99984H0.916992M0.916992 4.99984L5.00033 9.08317M0.916992 4.99984L5.00033 0.916504" stroke="#344054" stroke-width="1.17" stroke-linecap="round" stroke-linejoin="round"/></svg>
      {{ $t('profile.return')}}
    </a>
