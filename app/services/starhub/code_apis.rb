module Starhub
  module CodeApis
    ...
    def get_codes(current_user, keyword, sort_by, task_tag, framework_tag, license_tag, page = 1, per = 16)
      get_repos('codes', current_user, keyword, sort_by, task_tag, framework_tag, license_tag, page, per)
    end
